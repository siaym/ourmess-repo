  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="relative z-40 h-16 flex items-center justify-between px-4 sm:px-8 border-b border-border/50 bg-background/50 backdrop-blur-md">
        ...
        <main className="relative z-0 flex-1 overflow-y-auto p-4 sm:p-8">
          {children}
        </main>
      </div>
    </div>
